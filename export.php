...
$image = draw_image( $im_width, $im_height, $cell_size, $margin, $num_of_weeks, $num_of_days, $contribs, true );

$img_url = 'http://ozh.org/contribution/temp/' . $image ;

$location = 'http://www.zazzle.com/api/create/at-238080209952171382?'.
	...
	'&tc='.
	'&ic='.
	'&t_contribimg_iid='. urlencode( $img_url );
